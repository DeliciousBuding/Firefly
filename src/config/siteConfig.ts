...
export const siteConfig: SiteConfig = {
	...
	// 主题色
	themeColor: {
		// 主题色的默认色相 —— 注意这是 oklch 色相角（非 HSL）！
		// oklch 色相映射：0=红 165=绿 200=青 215=青绿 250=蔚蓝 270=纯蓝 280=蓝紫
		// 之前误设 215 实为青色，视觉偏青绿；250 才是感知上的蓝色
		hue: 250,
		// 是否对访问者隐藏主题色选择器（固定主题色，忽略访客 localStorage 旧值）
		fixed: true,
